...
/**
 * Интерфейс, используемый {@link ListenersFactory} для уведомления о необходимости
...
public interface ListenersParent<L> {
     ...
     * @param notifier <i>Notifier</i>-интерфейс к данному <i>ListenersFactory</i>-объекту. В простейшем случае
